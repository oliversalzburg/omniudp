...
namespace OmniUdp {
	...
	internal static class Program {
		...
		private static class CommandLineOptions {
			...
			/// <summary>
			///     The handle of the stream to which we should output events.
			/// </summary>
			internal static string StreamHandle { get; set; }
			#endregion
			/// <summary>
			...
			/// <summary>
			///     Path to the .pfx/.p12 certificate to use to secure connections.
			/// </summary>
			internal static string CertificateFilePath { get; set; }

			/// <summary>
			///     The password for the certificate that is used for the secure connection.
			/// </summary>
			internal static string CertificateFilePassword { get; set; }
		}
		...
		private static void Main( string[] args ) {
			...
			if( !String.IsNullOrEmpty( CommandLineOptions.StreamHandle ) ) {
				eventHandlingStrategy.Strategies.Add(
					new PipeStreamStrategy(
						CommandLineOptions.StreamHandle,
						new Payload.StringFormatter(
							CommandLineOptions.Ascii,
							CommandLineOptions.Identifier ) ) );
			}
		...
		private static bool ParseCommandLine( IEnumerable<string> args ) {
			OptionSet options = new OptionSet {
				...
				{"handle=", "Write events to this stream.", v => CommandLineOptions.StreamHandle = v},
				...
				{"pfx-key=", "The password to open the x509 certificate.", v => CommandLineOptions.CertificateFilePassword = v},
